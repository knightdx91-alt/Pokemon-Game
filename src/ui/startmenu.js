...
window.GameStartMenu = (function () {
    ...
    function _buildTrainerCard(el) {
        _makeCanvasShell(el, function(ctx) {
            _loadTrainerCardBg(function(bg) {
                ...
                ctx.font = 'bold '+(16*S)+'px "Press Start 2P", monospace';
    ...
    function _drawJournalAchAtlas(ctx, S, CYAN, TEXT, DIM) {
        ...
        // Scroll indicators
        if (_achOffset > 0) { ctx.fillStyle = CYAN; ctx.font=(10*S)+'px "Press Start 2P", monospace'; ctx.fillText('▲', GBA_W/2-4, (listY-2)*S); }
        if (_achOffset + LIST_ROWS < filtered.length) { ctx.fillStyle = CYAN; ctx.font=(10*S)+'px "Press Start 2P", monospace'; ctx.fillText('▼', GBA_W/2-4, (listY+LIST_ROWS*14)*S); }
    ...
    function _drawAchievementsCanvas(ctx, bg) {
        ...
        ctx.font = (16*S)+'px "Press Start 2P", monospace';
        ctx.fillStyle = COL_CYAN;
        ...
        // Scroll indicators
        if (_achOffset > 0) { ctx.fillStyle = COL_CYAN; ctx.font=(10*S)+'px "Press Start 2P", monospace'; ctx.fillText('▲', GBA_W/2 - 4, (listY - 1)*S); }
        if (_achOffset + LIST_ROWS < filtered.length) { ctx.fillStyle = COL_CYAN; ctx.font=(10*S)+'px "Press Start 2P", monospace'; ctx.fillText('▼', GBA_W/2 - 4, (listY + LIST_ROWS*14)*S); }
    ...
    function _openPartySummary(mon, idx, filled, returnCb) {
        ...
        function drawSummary() {
            ...
            ctx.font = 'bold '+(10*S)+'px "Press Start 2P", monospace'; ctx.fillStyle = CYAN; ctx.textBaseline = 'top';
            ...
            ctx.font = 'bold '+(10*S)+'px "Press Start 2P", monospace'; ctx.fillStyle = TEXT; ctx.textBaseline = 'top';
            var gStr = mon.gender==='M' ? ' ♂' : mon.gender==='F' ? ' ♀' : '';
            ctx.fillText(_monDisplayName(mon)+gStr, 8*S, 23*S);
            ctx.font = (16*S)+'px "Press Start 2P", monospace'; ctx.fillStyle = DIM;
            ...
            if (_tab === 0) {
                ...
                ctx.font = (16*S)+'px "Press Start 2P", monospace'; ctx.textBaseline = 'top';
                ...
                // Battle Moves
                ctx.font = 'bold '+(16*S)+'px "Press Start 2P", monospace'; ctx.textBaseline = 'top';
    ...
    function _drawPokedexCanvas(ctx, bg) {
        ...
        if (start > 0) { ctx.fillStyle = COL_CYAN; ctx.font=(16*S)+'px "Press Start 2P", monospace'; ctx.fillText('▲', GBA_W-12*S, 22*S); }
        if (end < _dexList.length) { ctx.fillStyle = COL_CYAN; ctx.font=(16*S)+'px "Press Start 2P", monospace'; ctx.fillText('▼', GBA_W-12*S, 150*S); }
    }
    ...
    function _openPokenavMap() {
        ...
        function draw() {
            ...
            // Region label
            ctx.font = 'bold '+(16*S)+'px "Press Start 2P", monospace'; ctx.fillStyle = '#18b8c8';
            ...
            ctx.font = (16*S)+'px "Press Start 2P", monospace'; ctx.fillStyle = '#c8d8e8';

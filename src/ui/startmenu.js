...
window.GameStartMenu = (function () {
    ...
    function _openPartySummary(mon, idx, filled, returnCb) {
        ...
        function drawSummary() {
            ...
            ctx.font = 'bold '+(9*S)+'px "Press Start 2P", monospace'; ctx.fillStyle = CYAN; ctx.textBaseline = 'top';
            ...
            ctx.font = 'bold '+(9*S)+'px "Press Start 2P", monospace'; ctx.fillStyle = TEXT; ctx.textBaseline = 'top';
            ...
            if (_tab === 0) {
                ...
                // Battle Moves
                ctx.font = 'bold '+(9*S)+'px "Press Start 2P", monospace'; ctx.textBaseline = 'top';
    ...
    function _openPokenavMap() {
        ...
        function draw() {
            ...
            // Region label
            ctx.font = 'bold '+(9*S)+'px "Press Start 2P", monospace'; ctx.fillStyle = '#18b8c8';
